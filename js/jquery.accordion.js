(function ($, window, document) {
  $.fn.acc = function (options) {
    ...
    return this.each(function () {
      ...
      var smallScreen;
      var accordionItemContainer = $(container).find(
      ...
      function smallAccordionReset() {
        ...
        $(
          ".accordion-item-content > div:last-of-type, .accordion-item-container, .accordion-item-content > div:first-of-type"
        ).css({
          "max-width": "100%",
          width: $(window).width(),
          float: "left",
